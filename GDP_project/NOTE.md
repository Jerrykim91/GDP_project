...
# count=0
# for i in doc:
#     print("나라이름 : ",i["Country Name"])#+" 2017년 GDP "+i["2017"]+i["2017"]+i["2017"]+i["2017"])
#     for j in range(0,58) : 
#         num = str(j+1960)
#         real_num = int(float(i[num]))
#         print(num,"년도","{:,}".format(real_num),"$")
#         #print("{:,}".format(234234234234))



# doc = coll.find_one({'Country Name':'China'})
# print(doc["Country Name"])
...
table = db.get_collection("real_gdp5") ##collection 생성 

data = table.find({},{"_id":False, "CountryCode":False, "IndicatorName":False, "IndicatorCode" : False,"GDP_" : False})

test_sum = """

INSERT INTO GDP_GDPTABLE2(
    COUNTRYNAME,GDP_1960,GDP_1961,GDP_1962,GDP_1963,GDP_1964,GDP_1965,GDP_1966,GDP_1967,GDP_1968,GDP_1969,
GDP_1970,GDP_1971,GDP_1972,GDP_1973,GDP_1974,GDP_1975,GDP_1976,GDP_1977,GDP_1978,GDP_1979,
GDP_1980,GDP_1981,GDP_1982,GDP_1983,GDP_1984,GDP_1985,GDP_1986,GDP_1987,GDP_1988,GDP_1989,
GDP_1990,GDP_1991,GDP_1992,GDP_1993,GDP_1994,GDP_1995,GDP_1996,GDP_1997,GDP_1998,GDP_1999,
GDP_2000,GDP_2001,GDP_2002,GDP_2003,GDP_2004,GDP_2005,GDP_2006,GDP_2007,GDP_2008,GDP_2009,
...
for tmp in data :
    ...
    tmp['CountryName'] = r'{}'.format(tmp['CountryName']) 
    print("22",tmp['CountryName'] )
    sql =test_sum
